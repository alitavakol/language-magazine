...
public class IabHelper {
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreSkus) throws IabException, NullPointerException {
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
                                    List<String> moreSubsSkus) throws IabException, NullPointerException {
        checkNotDisposed();
    ...
    /**
     * performs simple de-cyphering algorithms on app-store public key and returns it.
     *
