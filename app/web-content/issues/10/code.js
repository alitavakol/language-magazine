...
adjustLayout = function(options) {
	...
	css = "\
		...
		.accent-dark { color: " + tinycolor(accentColor).darken().darken().toHexString() + "; } \
		.fill-light { background-color: " + tinycolor(accentColor).lighten().lighten().toHexString() + "; } \
		.fill-lighter { background-color: " + tinycolor(accentColor).lighten().lighten().lighten().toHexString() + "; } \
